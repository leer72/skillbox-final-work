 ...
 */
final class Version20220709112829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, keyword_id INT DEFAULT NULL, title LONGTEXT DEFAULT NULL, theme VARCHAR(255) NOT NULL, slug VARCHAR(100) NOT NULL, body LONGTEXT DEFAULT NULL, words LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), INDEX IDX_23A0E66F675F31B (author_id), UNIQUE INDEX UNIQ_23A0E66115D4552 (keyword_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
